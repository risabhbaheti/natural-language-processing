...
class ParsingSystem:
    ...
    def apply(self, c, t):
        ...
        =================================================================
        """
        #Checking if the transition is Right/left/only shift and updating the configuration accordingly
        if t.startswith("R"):
            #obtaining label , head and tail and then updating stack and configuration
            label = t[2:-1]
            tail = c.getStack(0)
            head=c.getStack(1)
